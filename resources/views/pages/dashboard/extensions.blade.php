            ...
            <div class="col-lg-12 col-xlg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card- p-5">
                        ...
                        @endif
                        <form class="form-horizontal form-material mx-2" action="{{ route('extensions.update',$users['id']) }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button class="btn btn-success text-white" type="submit">Update Extension</button>
                                </div>
                            </div>
                        </form>
                    </div>
